...
static const union AnimCmd sSpriteAnim_TypeFairy[] = { //TODO: check if sSpriteAnim_TypeFairy is needed anywhere else
...
static const u8 sMoveTypeToOamPaletteNum[NUMBER_OF_MON_TYPES + CONTEST_CATEGORIES_COUNT] =
{
    ...
    [TYPE_DARK] = 13,
    [TYPE_FAIRY] = 14,
    [NUMBER_OF_MON_TYPES + CONTEST_CATEGORY_COOL] = 13, //TODO: do I need to reduce all the numbers by 1?
